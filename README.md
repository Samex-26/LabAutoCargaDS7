...
1. Abre tu navegador (Microsoft Edge, por ejemplo).  
2. Accede a tu `index.php` (vía localhost si usas WampServer).  
3. Si ves el mensaje de tu clase `Usuario` sin errores de *Class not found*, has completado el laboratorio con éxito.  
